...
import { getOrchestratorAgentId } from '@/lib/watson'
          ...
          <div className="flex flex-1 items-center gap-2 px-3">
            ...
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator />
                <BreadcrumbItem>
                  <BreadcrumbPage>Ask</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
        ...
        <div className="flex flex-1 flex-col gap-6 p-6">
          <div className="space-y-1">
            ...
            <p className="text-muted-foreground">
              Ask a question. We’ll route you to the right agent and open the chat.
            </p>
          </div>
          <AskContent orchestratorAgentId={orchestratorAgentId} />
        </div>
      </SidebarInset>
    </SidebarProvider>
  )
